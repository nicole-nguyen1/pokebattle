...
/**
 * Check if a given object implements the XY interface.
 */
export function instanceOfXY(value: object): value is XY {
...
export function XYFromJSON(json: any): XY {
    return XYFromJSONTyped(json, false);
}

export function XYFromJSONTyped(json: any, ignoreDiscriminator: boolean): XY {
    if (json == null) {
        return json;
    }
    return {
...
export function XYToJSON(json: any): XY {
    return XYToJSONTyped(json, false);
}

export function XYToJSONTyped(value?: XY | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
